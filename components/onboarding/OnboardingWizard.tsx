...
import { ChevronRight, Check, Sparkles, Shield, LayoutGrid, User, ArrowRight, ArrowLeft, Wallet, PartyPopper } from 'lucide-react';

export const OnboardingWizard: React.FC = () => {
    const { completeOnboarding } = useFinance();
    const { setCurrency, currency } = useTheme();
    
    // Steps: 1=Welcome, 2=Tour, 3=Profile, 4=Data, 5=Celebrating
